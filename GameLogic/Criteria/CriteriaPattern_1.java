 ...
 * A <code>CriteriaPattern_1</code> will check if the List contains "Blue" shapes and
 * return the corresponding list
 */
public class CriteriaPattern_1 implements Criteria {
...
//            if (shape.getColor().equalsIgnoreCase("BLUE")) {
            if(shape.getClassification().getPattern() == PatternEnum.PATTERN_1){
