 ...
 * A <code>CriteriaCategory_1</code> will check if the List contains "Square" shapes and
 * return the corresponding list
 */
public class CriteriaCategory_1 implements Criteria {
...
//            if (shape.getColor().equalsIgnoreCase("BLUE")) {
            if(shape.getClassification().getCategory() == CategoryEnum.CATEGORY_1){
